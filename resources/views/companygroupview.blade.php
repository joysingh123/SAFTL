...
<div class="container">
    ...
    <form action="{{ route('importcompanygroup') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        
        Install Base:<select name="company_group" class="form-control">
            <option value="">Select Your Company Group</option>
            @foreach($company_group AS $cg)
