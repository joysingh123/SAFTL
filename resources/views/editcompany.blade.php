                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('editcompany') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            <label for="linkedin_id" class="col-md-4 col-form-label text-md-right">{{ __('Linkedin Id') }}</label>
                            <div class="col-md-4">
                                <input type="hidden" name="linkedin_id" value="{{$company->linkedin_id}}" />
                                <input id="linkedin_id" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$company->linkedin_id}}" name="linkedin_id" value="{{ old('linkedin_id') }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="company_domain" class="col-md-4 col-form-label text-md-right">{{ __('Company Domain') }}</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="employee_count" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$company->employee_count_at_linkedin}}" name="employee_count" value="{{ old('employee_count') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="linkedin_id" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$company->city}}" name="city" value="{{ old('city') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="postal_code" class="col-md-4 col-form-label text-md-right">{{ __('Postal Code') }}</label>
                            <div class="col-md-4">
                                <input id="linkedin_id" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$company->postal_code}}" name="postal_code" value="{{ old('postal_code') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="employee_size" class="col-md-4 col-form-label text-md-right">{{ __('Employee Size') }}</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="website" class="col-md-4 col-form-label text-md-right">{{ __('Email') }}</label>
                            <div class="col-md-4">
