...
class UserImportEmailValidation2 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'validate:useremail2';
    ...
    public function handle()
    {
        ...
        if($emails->count() > 0){
            ...
            $result = EmailForValidation::whereIn('id', $plucked_email_array)->update(['status' => 'cron2']);
            if($result > 0){
